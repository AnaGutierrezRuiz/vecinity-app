        ...
        {user?.community ? (
          <div className="sticky bottom-0 mb-2 left-0 z-50 w-full h-16 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600 lg:hidden md:hidden">
            <div className="grid h-full max-w-lg grid-cols-3 mx-auto border-b">
              ...
              <Link to={`/communities/${user?.community?.id}`} className="inline-flex flex-col items-center justify-center px-5 border-gray-200 border-x hover:bg-gray-50 dark:hover:bg-gray-800 group dark:border-gray-600">
                <svg className="w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-orange dark:group-hover:text-blue-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              ...
              <Link to={`/communities/${user?.community?.id}/events`} className="inline-flex flex-col items-center justify-center font-medium px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
