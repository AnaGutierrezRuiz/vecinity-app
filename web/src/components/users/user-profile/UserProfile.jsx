    ...
    <>
      <div className="border-b border-gray-200 dark:border-gray-700 flex justify-center">
        <ul className="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
          <li className="mr-2">
            <Link to={`/communities/${user?.community.id}/users/${user?.id}/account`} className="inline-flex p-4 border-b-2 border-transparent rounded-t-lg hover:text-orange hover:border-orange dark:hover:text-gray-300 group">
          ...
          <li className="mr-2">
            <Link to={`/communities/${user?.community.id}/users/${user?.id}/settings`} className="inline-flex p-4 border-b-2 border-transparent rounded-t-lg hover:text-orange hover:border-orange dark:hover:text-gray-300 group">
      ...
      <div className="flex flex-col items-center">
        ...
        <button className="flex -mt-20 -mr-48 bg-orange text-black font-bold rounded-full my-6 py-2 px-2 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
