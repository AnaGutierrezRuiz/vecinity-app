      ...
      <PageLayout title="My Community">
        <div className="grid grid-cols-2 gap-8 justify-items-center lg:grid-cols-3 md:grid-cols-2 lg: pt-16">
          ...
          <NavLink to={`/communities/${user?.community.id}/reservations`}>
            <div className="mb-5">
              <svg className="ml-3 hover:animate-bounce" width="80px" height="80px" viewBox="0 0 24 24" stroke-width="2" fill="none" xmlns="http://www.w3.org/2000/svg" color="#809d7b"><path d="M8.5 4H6a2 2 0 00-2 2v14a2 2 0 002 2h6M15.5 4H18a2 2 0 012 2v9" stroke="#809d7b" stroke-width="2" stroke-linecap="round"></path><path d="M8 6.4V4.5a.5.5 0 01.5-.5c.276 0 .504-.224.552-.496C9.2 2.652 9.774 1 12 1s2.8 1.652 2.948 2.504c.048.272.276.496.552.496a.5.5 0 01.5.5v1.9a.6.6 0 01-.6.6H8.6a.6.6 0 01-.6-.6z" stroke="orange" stroke-width="2" stroke-linecap="round"></path><path d="M15.5 20.5l2 2 5-5" stroke="orange" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
          ...
          <NavLink to={`/communities/${user?.community.id}/users/${user?.id}/account`}>
            <div className="mb-5">
              <svg className="hover:animate-spin" width="80px" height="80px" stroke-width="2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#809d7b"><path d="M12 15a3 3 0 100-6 3 3 0 000 6z" stroke="orange" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M19.622 10.395l-1.097-2.65L20 6l-2-2-1.735 1.483-2.707-1.113L12.935 2h-1.954l-.632 2.401-2.645 1.115L6 4 4 6l1.453 1.789-1.08 2.657L2 11v2l2.401.655L5.516 16.3 4 18l2 2 1.791-1.46 2.606 1.072L11 22h2l.604-2.387 2.651-1.098C16.697 18.831 18 20 18 20l2-2-1.484-1.75 1.098-2.652 2.386-.62V11l-2.378-.605z" stroke="#809d7b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
